...
#    print "\nThe five energies are:"
        ...
        D=pow(0.287E-9,2)*w4/w3*ffactor*w2
        #print w4/w3, w2
        #print ratio, Ffactor
        #print ffactor
...
#    print "\n"
        ...
        #print temp*11604-273, D*math.exp(-Evfor/temp)/(0.78*math.exp(-2.6/temp)*1E14),Evfor
        print 10000/(temp*11604), D*math.exp(-Evfor/temp)
        x.append(1/temp)
        y.append(math.log(D*math.exp(-Evfor/temp),10))
